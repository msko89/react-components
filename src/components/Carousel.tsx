...
const banners = [
  'https://static.sixshop.com/resources/images/case/rael.png',
  'https://static.sixshop.com/resources/images/case/soundsgood.png',
  'https://static.sixshop.com/resources/images/case/jitachon.png',
  'https://static.sixshop.com/resources/images/case/lykke.png',
  'https://static.sixshop.com/resources/images/case/moaa.png',
];
    ...
    <Base onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      <Nav>
        {Array.from({ length: banners.length }).map((_, index) => (
          <NavItem key={index} onClick={() => handleNav(index)}>
